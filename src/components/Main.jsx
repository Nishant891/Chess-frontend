    ...
    <div className="w-full relative" style={myStyles}>
      ...
      <div className="bg-transparent w-full h-full flex justify-center z-10 absolute inset-0 text-white mt-24">
        <div className="flex flex-col items-center">
          ...
          <div className="mt-4">
            <button
              className="transition duration-500 ease-in-out px-4 py-3 bg-[#57cc99] transform hover:-translate-y-1 hover:scale-110  active:opacity-80 text-black text-xl rounded-lg mb-4"
              onClick={() => {
                navigate("/signup");
              }}
            >
